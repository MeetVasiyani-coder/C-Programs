                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          ...
                          } else if (!RegExp(r'^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{5,}$')
                              .hasMatch(value)) {
                                ...
                                if (_formKey.currentState!.validate()) {
                                  if (widget.user == null) {
                                    ...
                                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) {
                                      return UserList(users: widget.users,favourite: false,);
                                    }));
                                    ...
                                    int userIndex = widget.users.userlist.indexWhere((element) => element[Name] == nameController.text);

                                    Navigator.pop(context);
                                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) {
                                      return AboutUser(users: widget.users, user: widget.users.userlist[userIndex],);
                                    },));
