...
class _AddUserScreenState extends State<AddUserScreen> {
  ...
  bool _isAtLeastOneHobbySelected() {
    return hobbies.values.any((value) => value);
  }
  ...
  void initState() {
    ...
    if (widget.user != null) {
      ...
      hobbies = Map<String, bool>.from(widget.user![Hobbies]);
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: "Full Name",
                          prefixIcon:
                              Icon(Icons.person, color: Color(0xFFFF778D)),
                          ...
                          focusedBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(12),
                            borderSide:
                                BorderSide(color: Color(0xFFFF778D), width: 2),
                          ),
                          filled: true,
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: "Address",
                          prefixIcon:
                              Icon(Icons.home, color: Color(0xFFFF778D)),
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(12),
                          ),
                          enabledBorder: OutlineInputBorder(
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: "Email",
                          prefixIcon:
                              Icon(Icons.email, color: Color(0xFFFF778D)),
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(12),
                          ),
                          enabledBorder: OutlineInputBorder(
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: "Mobile",
                          prefixIcon:
                              Icon(Icons.phone, color: Color(0xFFFF778D)),
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(12),
                          ),
                          enabledBorder: OutlineInputBorder(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CheckboxListTile(
                              title: Row(
                                children: [
                                  Icon(Icons.book, color: Color(0xFFFF778D)),
                                  SizedBox(width: 10),
                            ...
                            CheckboxListTile(
                              title: Row(
                                children: [
                                  Icon(Icons.palette, color: Color(0xFFFF778D)),
                                  SizedBox(width: 10),
                                  Text("Arts & Craft"),
                                ],
                              ),
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: "Password",
                          prefixIcon:
                              Icon(Icons.lock, color: Color(0xFFFF778D)),
                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  try {
                                    if (widget.user == null) {
                                      await widget.users.addUserToList(
                                        nameController.text,
                                      ...
                                      int userIndex = widget.users.userlist
                                          .indexWhere((element) =>
                                              element[USER_ID] ==
                                              widget.user![USER_ID]);
