...
class FavouriteUser extends StatefulWidget {
  final User users;
  const FavouriteUser({super.key, required this.users});
...
class _FavouriteUserState extends State<FavouriteUser> {
  ...
  void initState() {
    super.initState();
    filteredUsers = widget.users.userlist.where((user) => user[Favorite]).toList();
  }
        ...
        filteredUsers = widget.users.userlist.where((user) {
          return user[Favorite] &&
                 (user[Name].toString().toLowerCase().contains(query.toLowerCase()) ||
                  ...
                  user[Mobile].toString().toLowerCase().contains(query.toLowerCase()) ||
                    ...
                    Container(
                      ...
                      child: TextField(
                        decoration: InputDecoration(
                          ...
                          prefixIcon: const Icon(Icons.search, color: Color(0xFFFF778D)),
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  color: const Color(0xFFFF778D).withOpacity(0.1),
                                                ...
                                                children: [
                                                  IconButton(
                                                    icon: const Icon(
                                                      ...
                                                      SnackBar(
                                                        content: Text("${user[Name]} removed from favorites successfully"),
                                                              ...
                                                              builder: (context) => AlertDialog(
                                                                ...
                                                                actions: [
                                                                  ...
                                                                  TextButton(
                                                                    ...
                                                                    onPressed: () {
                                                                      filteredUsers.removeAt(index);
                                                                      widget.users.userlist.removeWhere(
                                          ...
                                          Row(
                                            children: [
                                              const Icon(Icons.email, color: Color(0xFFFF778D), size: 20),
                                              const SizedBox(width: 8),
                                              Expanded(
                                                child: Text(
                                                  user[Email],
